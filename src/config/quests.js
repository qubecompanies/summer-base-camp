...
export const WEEKDAY_QUESTS = [
  ...
  { id: 'water', cat: 'Health / hydration', glyph: '💧', color: 'var(--blue)', min: 10, pts: 6, title: 'Hydrate — drink your water',
  ...
  { id: 'tidy', cat: 'Tidy / reset', glyph: '🧹', color: 'var(--coral)', min: 15, pts: 9, title: 'Tidy & reset your space',
    ideas: ['Make your bed', 'Clear your desk', 'Floor pickup', 'Reset your backpack', 'Put your laundry away'] },
  { id: 'kind', cat: 'Kindness', glyph: '💛', color: 'var(--purple)', min: 15, pts: 10, title: 'Random act of kindness',
    ideas: ['Compliment someone', 'Help without being asked', 'Write a kind note', 'Share something', 'Let your brother go first'] },
  { id: 'music', cat: 'Music', glyph: '🎵', color: 'var(--teal)', min: 25, pts: 14, title: 'Music practice',
