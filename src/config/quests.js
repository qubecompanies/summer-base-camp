...
export const WEEKDAY_QUESTS = [
  { id: 'read', cat: 'Reading', glyph: '▲', color: 'var(--blue)', min: 40, pts: 15, title: 'Read 30+ minutes',
  ...
  { id: 'skill', cat: 'Skill practice', glyph: '★', color: 'var(--purple)', min: 45, pts: 15, title: 'Skill practice (15+ min)',
    byPlayer: {
  ...
  { id: 'scrip', cat: 'Scripture / spiritual', glyph: '✦', color: 'var(--amber)', min: 30, pts: 12, title: 'Scripture + journal',
  ...
  { id: 'biz', cat: 'Side business / money', glyph: '●', color: 'var(--teal)', min: 55, pts: 22, title: 'Side business work',
    byPlayer: {
  ...
  { id: 'serve', cat: 'Service', glyph: '✚', color: 'var(--coral)', min: 50, pts: 18, title: 'Help someone today',
    ideas: ['Help your brother', 'Help Mom / Dad', 'Call a grandparent', 'Tidy a shared space', 'Serve a neighbor', 'Make someone a snack', 'Do a chore that isn’t yours', 'Write an encouraging note'] },
  { id: 'friend', cat: 'Friends / social', glyph: '◑', color: 'var(--blue)', min: 55, pts: 20, title: 'Invite a friend (screen-free)',
    ideas: ['Shoot hoops together', 'Bike or scooter ride', 'Build / make something', 'Pool or swim', 'Yard game or tag'] },
  { id: 'water', cat: 'Health / hydration', glyph: '💧', color: 'var(--blue)', min: 15, pts: 6, title: 'Hydrate — drink your water',
  ...
  { id: 'tidy', cat: 'Tidy / reset', glyph: '🧹', color: 'var(--coral)', min: 25, pts: 9, title: 'Tidy & reset your space',
    ideas: ['Make your bed', 'Clear your desk', 'Floor pickup', 'Reset your backpack', 'Put your laundry away'] },
  { id: 'kind', cat: 'Kindness', glyph: '💛', color: 'var(--purple)', min: 25, pts: 10, title: 'Random act of kindness',
    ideas: ['Compliment someone', 'Help without being asked', 'Write a kind note', 'Share something', 'Let your brother go first'] },
  { id: 'music', cat: 'Music', glyph: '🎵', color: 'var(--teal)', min: 40, pts: 14, title: 'Music practice',
  ...
  { id: 'b1', bonus: true, cat: 'Bonus', glyph: '＋', color: 'var(--amber)', min: 60, pts: 25, title: 'Read a chapter out loud',
    ideas: ['To a sibling', 'To a parent', 'Record it'] },
  { id: 'b2', bonus: true, cat: 'Bonus', glyph: '＋', color: 'var(--amber)', min: 60, pts: 25, title: 'Teach your brother a new skill',
...
export const WEEKEND_QUESTS = [
  { id: 'wadv', cat: 'Family adventure', glyph: '◆', color: 'var(--teal)', min: 60, pts: 20, title: 'Join a family outing / adventure',
    ideas: ['Hike / lake', 'Bike the trail', 'Help plan it', 'Pack the cooler', 'Be a good sport'] },
  { id: 'wbuild', cat: 'Big build / project', glyph: '◗', color: 'var(--purple)', min: 65, pts: 24, title: 'Long creative / build project',
    ideas: ['Finish a build', 'Film + edit a video', 'Woodworking with Dad', 'Big Lego set', 'Paint / draw a piece'] },
  { id: 'wserve', cat: 'Service project', glyph: '✚', color: 'var(--coral)', min: 60, pts: 22, title: 'Bigger service project',
    ideas: ['Yard work for a neighbor', 'Church service', 'Help a sibling all day', 'Clean the garage', 'Visit grandparents'] },
  { id: 'wprep', cat: 'Prep for the week', glyph: '✦', color: 'var(--amber)', min: 35, pts: 14, title: 'Set up next week',
    ideas: ['Reset your room', 'Lay out the week', 'Plan business steps', 'Sunday scriptures', 'Charge + stash devices'] },
  { id: 'wread', cat: 'Reading', glyph: '▲', color: 'var(--blue)', min: 50, pts: 16, title: 'Long read (45+ min)',
